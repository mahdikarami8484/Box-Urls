...
?>
    ...
    <div class="form col-lg-6 offset-lg-3 bg-dark">
        <div class="mb-3">
            ...
            <input type="name" value="<?=$_SESSION['login']['name']?>" class="form-control" id="InputName">
            <div id="errorName" class="form-text text-danger"></div>
        </div>
        <div class="mb-3">
            <label for="InputEmail" class="form-label">ایمیل :</label>
            <input type="email1" <?php if(checkemail()) echo "disabled"; ?> value="<?=$_SESSION['login']['email']?>" class="form-control ltr" placeholder="name@gmail.com" id="InputEmail">
            <div id="errorEmail" class="form-text text-danger"></div>
        </div>
        <div class="mb-3">
            <label for="InputPassword" class="form-label">رمز عبور :</label>
            <input type="password" class="form-control ltr" id="InputPassword" aria-describedby="passwordHelp">
        ...
        <input type="password" class="form-control ltr" id="InputToken" value="<?=creatToken()?>" hidden>
        <button type="submit" id="save" class="btn btn-success">ذخیره</button>
    </div>
<?php
